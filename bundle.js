...
(function () {
    ...
    class Renderer {
        ...
        _setCellMarked(rendererContext, row, col) {
            ...
            rendererContext.updateDivCell(row, col);
         ...
         */
        updateDivCell(row, col) { // TODO: przydaloby sie zmienic nazwe na cos w stylu flipCell - funkcja ZAWSZE odwraca (no chyba ze nie jest hidden)
            // console.log(div);
            let cell = this.cellsObjects[row][col];
            let cellClasses = this.cellsDivs[row][col].tableCell.classList;
            // console.log("jestem tu", cell, tableCell);

            cellClasses.toggle("flip");
            // if (!cellClasses.contains("flip")) {
            // }
            // else if (cellClasses.contains("flip-back")) {

            // }
            // TODO: moze nie hardcodowac tych nazw klas flip itp
            // if (tableCell.classList.contains("flip-back")) {
            //     tableCell.classList.remove("flip");
            //     tableCell.classList.remove("flip-back");
            //     tableCell.classList.add("flip");
            // }
            // else {
            //     tableCell.classList.add("flip-back");
            // }
            ...
            //     tableCell.classList.add("flip-back");
            // }
            // this.cellsDivs[row][col].tableCell.classList.add("flip")
